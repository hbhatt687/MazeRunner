...
public class Maze extends JPanel implements Runnable {
    ...
    int rows = 91;          // number of rows of cells in maze, including a wall around edges
    int columns = 101;       // number of columns of cells in maze, including a wall around edges
