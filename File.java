...
//added these fields from Maze class to this class to open/close JFrames.
	...
	public StyleOptionsPanel(){
		...
		saying2.setFont(new Font("Helvetica", Font.PLAIN, 30));
		//add(field);
		JLabel saying3=new JLabel();
		saying3.setText(String.valueOf(c));
		saying3.setFont(new Font("Helvetica", Font.PLAIN, 30));
		
		JLabel saying4=new JLabel("Columns");
		saying4.setFont(new Font("Helvetica", Font.PLAIN, 30));
		
		JLabel saying5=new JLabel("You Inputed: ");
		saying5.setFont(new Font("Helvetica", Font.PLAIN, 30));
